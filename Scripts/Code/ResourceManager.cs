...
{
    public static Sprite GetSprite(this string name)
    {
        return ResourceManager.GetSprite(name);
    }
    public static Material GetMaterial(this string name)
    {
        return ResourceManager.GetMaterial(name);
    }
    public static Texture GetTexture(this string name)
    {
